...
class DBStack extends cdk.Stack {
    constructor(scope, id, props) {
        ...
        this.casesTable = new dynamodb.Table(this, "[ChallengeName]CaseHistory", {
         ...
         // Table to store AI-generated exam questions and metadata
        const questionTable = new dynamodb.Table(this, 'QuestionTable', {
            ...
            sortKey: { name: 'subject_grade', type: dynamodb.AttributeType.STRING },
            billingMode: dynamodb.BillingMode.PAY_PER_REQUEST
        });

        /* QuestionTable Attributes:
        - questionId (PK)
        - subject_grade (SK)
        - subject: string
        - grade: string
        ...
        */
        ...
        // Table to store user exam responses
        const responseTable = new dynamodb.Table(this, 'ResultTable', {
