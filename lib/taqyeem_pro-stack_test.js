...
class TaqyeemProStacktest extends Stack {
  constructor(scope, id, props) {
    ...
    PythonLambda.addToRolePolicy(new iam.PolicyStatement({
      ...
      resources: [
        'arn:aws:s3:::taqyeemprostack-curriculumdocsbucketb1075275-nawzlsopip18',          // For ListBucket
        'arn:aws:s3:::taqyeemprostack-curriculumdocsbucketb1075275-nawzlsopip18/*'         // For GetObject
      ]
    }));
